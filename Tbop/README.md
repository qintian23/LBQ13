...
参考专业技能：（来源于：<font color=blue>XGRIDS其域创新2022招聘岗位</font>）

**三维算法工程师**

> 工作职责

负责环境高精度重建相关算法预研和开发;·算法上进行技术攻坚，研究内容包括但不限于SLAM，SFM,MVS，网格处理，纹理贴图等。

> 任职要求(满足以下任一条及以上即可)

1. 熟悉基于点,体素,和网格的渲染或者可微渲染，或者 NERF;
2. 熟悉图形学(几何处理,渲染,动画仿真)，有项目经历或者发表论文经历的优先
3. 熟悉传统的 SFM,MVS 的算法或者最新的基于深度学习的算法
4. 熟悉常见的图形学库;
5. 熟悉多视图几何，优化理论，数值算法熟悉高性能计算，如多线程，CUDA

**SLAM算法工程师**

> 工作职责

负责基于激光雷达、imu和视觉等多传感器融合建图算法的研究和开发;
负责搭建多传感器标定系统;
负责扫图设备的系统软件搭建,算法集成和性能优化;

> 任职要求

1. 熟练掌握激光雷达建图的相关知识,包括特征提取、点云配准、闭环检测和图优化等;
2. 熟练掌握Linux下的C/C++开发,熟悉git.cmake等开发工具链,熟悉pcl、opencv.ceres-solver、g2o等常用库;
3. 熟悉激光雷达、IMU、相机等传感器,掌握多传感器融合算法;
4. 熟悉各种VIO算法、开源算法者优先
...
AI算法的研发，包括但不限于:物体检测、语义分割、语义理解、3D视觉等;
Al算法前沿算法跟进与研发;AI算法在实际应用领域的优化;·AI算法在生产环境的部署。

>岗位要求

1. 具有计算机视觉，机器学习优化算法,图形学算法或人工智能的相关经验;
2. 掌握常见的分类、检测、分割、生成模型;掌握良好的Python/C/C++编程基础;
3. 至少熟悉一种常用深度学习开发框架，比如PyTorch，Tensorflow;
4. 良好的英文文献阅读能力,能快速实现技术原型;有相关大赛获主要奖项经历，或者有视觉顶会论文发表;或者一线研发中有优秀结果产出。

**高性能计算工程师**

> 工作职责

参与公司高性能计算算法平台的搭建、开发和优化
参与公司 HPC建设的相关技术研究、设计和实现,例如并行计算、低延迟网络、并行文件系统等。研究和开发深度学习相关的通信、计算等技术，致力于GPU或其他异构硬件的高性能系统开发。·参与公司高性能分布式算法库的开发，大规模矩阵求解，优化问题等。

> 任职要求
1. 精通C++语言，具有3年及以上的linux环境下 C/C+多线程和多进程开发经验,熟练掌握Linux环境下C++网络编程技术。具有linux环境下丰富的代码调试经验。
2. 熟练掌握计算机系统相关原理和结构，了解常见处理器(X86、ARM等)、缓存、传输总线、存储介质的基础知识。
3. 具有OpenMP、MPI、RDMA 等高性能计算相关技术的开发经验，通过对Linux内核的优化,开发出基于CPU的高性能、低延迟抖动系统。
4. 具有多年的cuda并行计算开发经验优先。

**Web前端开发工程师**

> 岗位职责

负责基于 Vue3开发可视化编辑器和相关页面;
熟悉跨平台和小程序开发;
开发企业后台管理系统;

> 工作内容

1. 熟练使用开源框架Vue3熟练使用TypeScript语言熟练使用vite及其生态
2. 有小程序/flutter 开发经验者优先
3. 熟悉各种浏览器版本的适配、跨终端开发
4. 熟悉原子化 CSS、模块化开发模式和前端构建等工程化

**后端开发工程师**

> 工作职责

独立完成平台和项目核心模块的设计与编码、测试，并完成相关技术文档撰写及系统联调工作;遵循公司的开发流程和规范,制定开发计划，推进开发进度;
负责解决高并发高可用需求或业务复杂性等带来的关键技术难点突破;
参与系统整体架构设计和实施、开发规范设计等工作;

> 岗位要求

1. 5年以上 Java开发经验;具有Go等其他语言开发经验者优先;
2. 精通Spring Cloud和微服务架构等开发技术;有大数据、爬虫系统等相关开发经验者优先;
3. 精通Java 系统架构设计和核心开发技能，熟悉并发和多线程编程者优先;
4. 精通Mysql，MongoDB等数据库的应用技术和常规优化手段;
5. 熟悉 Redis，RocketMQ等常见基础开源组件的相关开发应用。

**云原生开发工程师**

> 工作职责

负责/参与分布式云原生业务和数据平台的涉及研发工作;
负责基于Kubernetes的业务后端整体架构设计、开发及维护;
协助参与业务系统的设计、实现及优化工作，提升集群与平台稳定性;
根据业务需要进行技术演进迭代,对平台中存在的问题进行定期反馈和推动改善;
负责 Kubernetes平台的资源管理，制定相关运维规划并识别风险、独立解决各种系统问题;能够独立负责网络、调度、存储等K8S模块的运维和工具开发工作,持续降本增效;

> 任职要求
1. 1.3年以上工作经验，精通Java 或 Go等开发语言至少一种，熟练使用 Python或 Shell 等脚本语言;有大型分布式系统开发经验者优先;
2. 精通 Kubernetes/Docker等云原生技术，具有生产环境安装、运维实践经验者优先;
3. 熟悉Linux操作系统，网络、存储、安全等计算机体系结构层面的知识，具有常见内核态问题的排查分析能力;
4. 熟悉Nginx等接入层技术,熟悉Ansible. Git-lab-CI等DevOps工具;
5. 具备良好的学习能力和沟通能力，具有抗压性和责任心，注重团队协作;乐于善于迎接新技术挑战者优先。

**软件测试工程师**

> 工作职责

参与产品需求评审,细化分析需求存在的问题、评估需求可测性并提出合理化建议。
配合需求和开发计划建立测试计划，明确测试时间安排，资源需求及交付物。
基于产品需求定义及软件需求规范，建立测试用例集，执行测试并输出测试结果。
根据产品性质及需求,负责设计自动化测试、性能测试方案并执行。
负责改进测试设计工程方法、流程规范及测试质量评估方法。

> 岗位要求
1. 熟悉Linux操作系统，以及git等开发常用工具;对自动化测试、性能测试理论及方法有较深理解,并具有实际项目经验;
2. 熟悉 python、shell 等常见脚本语言至少一种，并且有实际运用于测试项目的经验者优先考虑;熟悉业界主流的测试流程与规范（例如 CMMi等等)，了解业界常用的测试管理平台，了解业界的测试技术发展趋势者优先考虑;
3. 具有独立建立公司级的测试设计工程方法，测试设计流程规范，测试质量评估方法,测试闭环改进方法等能力优先考虑。

**嵌入式软件工程师**

> 工作职责

根据项目需要，参与项目方案评审和设计;负责Linux下驱动开发、调试;
负责 Linux驱动方案设计，驱动及中间层功能开发;
负责系统稳定问题分析解决。

> 岗位要求

1. 3年以上相关工作经验，熟悉Linux设备驱动开发(Camera、LCD、NAND、EMMC、USB、WiFi等模块驱动);
2. 熟悉 Linux内核架构、字符设备、设备驱动模型、内存管理、并发控制;
3. 掌握uboot移植、kernel配置、设备树、rootfs 制作和第三方库编译等;
4. 熟悉Linux操作系统，熟悉常用命令的使用;熟悉应用层对驱动的需求,熟悉常用的应用层与内核层的通讯方式;
5. 有硬件基础，能够熟练阅读datasheet和原理图等资料。

**智能硬件测试工程师**

> 工作职责
负责硬件项目自动化测试用例设计、开发，包括功能测试、性能测试等;
根据产品需求，制定测试方案，构建用户场景，编写和执行测试用例，发布测试报告;
分析测试中发现的问题，跟踪定位产品缺陷，积极推动研发解决，复盘测试过程,保障质量;负责测试用例挖掘及持续集成导入。
参与产品体验活动，从用户视角提出产品优化建议，提升产品体验。

> 任职要求

1. 计算机/软件工程/通讯工程/自动化相关专业，3年及以上工作经验;
2. 熟悉嵌入式软件测试流程及常用方法，能独立完成测试用例设计及编写;
3. 熟悉Linux或Unix操作系统,熟练掌握python/C/C++语言,熟悉持续集成技术,具有白盒测试、接口测试和自动化测试经验优先;
4. 熟悉常用持续集成工具如Jenkins、Gitlab CI.GoCD等,熟悉 git、gerrit。
